...
\begin{table}
\centering
\caption[Performance results in Class C RaceHorsesC]
{Performance results in Class C RaceHorsesC.}
...
{Multiple linear regression analysis result for Class C RaceHorsesC}
\resizebox{1.0\linewidth}{!}{
