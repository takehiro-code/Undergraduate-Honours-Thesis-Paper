...
\begin{table}
\centering
\caption[Performance results in Class B ParkScene]
{Performance results in Class B ParkScene.}
...
{Multiple linear regression analysis result for Class B ParkScene}
\resizebox{1.0\linewidth}{!}{
