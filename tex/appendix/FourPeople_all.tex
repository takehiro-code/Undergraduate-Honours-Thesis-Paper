...
\begin{table}
\centering
\caption[Performance results in Class E FourPeople]
{Performance results in Class E FourPeople.}
...
{Multiple linear regression analysis result for Class E FourPeople}
\resizebox{1.0\linewidth}{!}{
